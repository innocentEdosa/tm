          ...
          <div ref={scrollRef} className="flex-1 space-y-4 overflow-y-auto py-4">
            ...
            {chat.messages.map((message) => (
              <div key={message.id} className={message.role === "user" ? "flex justify-end" : "flex justify-start"}>
                <div className={message.role === "user" ? "max-w-[85%]" : "w-full max-w-[92%]"}>
                  <div className={message.role === "user" ? "rounded-lg rounded-br-sm bg-cta px-3.5 py-2 text-sm text-white" : "rounded-lg rounded-bl-sm bg-slate-100 px-3.5 py-2 text-sm text-primary"}>
            ...
            {sending && (
              <div className="flex justify-start">
                <div className="flex items-center gap-2 rounded-lg rounded-bl-sm bg-slate-100 px-3.5 py-2 text-sm text-slate-500">
